  ...
  return (
    <div className="pb-24 text-gray-100 antialiased">
      <div className="flex flex-col items-center">
        <div className="w-3/4 text-lg/loose">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to E Tune Works Private Limited, 1
                Tampines North Dr 1 #03-29 528559.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to E Tune Works, accessible from{' '}
                <a
                  href="https://etuneworks.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://etuneworks.com
                </a>
              </p>
            </li>
            <li>
          ...
          <h3 className="text-3xl font-bold">Use of Your Personal Data</h3>
          ...
          <h3 className="text-3xl font-bold">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-3xl font-bold">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-3xl font-bold">Security of Your Personal Data</h3>
          <p>
          ...
          <ul>
            <li>By email: vesta@etuneworks.com</li>
          </ul>
        </div>
      </div>
    </div>
